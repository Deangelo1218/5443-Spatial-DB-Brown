...
-- DROP INDEX IF EXISTS public.roads;

CREATE INDEX IF NOT EXISTS roads
    ON public.primary_roads USING btree
    (gid ASC NULLS LAST, fullname COLLATE pg_catalog."default" ASC NULLS LAST)
    TABLESPACE pg_default;